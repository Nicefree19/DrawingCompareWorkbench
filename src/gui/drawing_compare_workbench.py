...
from src.gui.workbench_overlay_model import (  # MONO-4 satellite extraction
...
from src.gui.workbench_summary_format import (  # MONO-4 satellite extraction
    _change_grade,
    _format_count,
    _int_value,
    _ko_change_type,
...
from src.gui.workbench_bbox_transform import (  # MONO-4 satellite extraction
    _cad_bbox_to_pixel_rect,
    _lightweight_tile_zoom_from_transform,
    _world_bbox_to_pixel_rect,
